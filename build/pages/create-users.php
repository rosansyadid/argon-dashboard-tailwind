                ...
                <div class="flex-none w-full max-w-full px-3">
                    <div
                        ...
                        <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                            <h6 class="dark:text-white">Add Users</h6>
                        </div>
                        <div class="flex-auto px-0 pt-0 py-12">
                            <div class="p-0 overflow-x-auto">
                                <form class="py-5 px-6" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="border-b border-gray-900/10 pb-12">
                                            ...
                                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                                    ...
                                                    <div class="mt-2">
                                                        <div
                                                            ...
                                                            <input type="text" name="nik" id="nik"
                                                                class="block w-full rounded-lg border py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6"
                                                                placeholder="123456">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-span-full">
                                                    ...
                                                    <div class="mt-2">
                                                        <input type="text" id="username" name="username"
                                                            ...
                                                            class="block w-full rounded-lg border py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6"></input>
                                                    </div>
                                                    <p class="mt-3 text-sm/6 text-gray-600">Enter Your Username.</p>
                                                </div>
                                                ...
                                                <div class="col-span-full">
                                                    ...
                                                    <p class="mt-3 text-sm/6 text-gray-600">Enter Your Name.</p>
                                                </div>
                                                <select name="role_id"
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <input minlength="1" type="password" name="password"
                                            class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                            placeholder="**************">
                                    </div>
                                    <div class="col-span-2">
                                        <label for="password_confirm"
                                            class="block mb-2 text-sm font-medium text-gray-600">Password
                                            Confirmation</label>
                                        <input minlength="1" type="password" name="password_confirm"
                                            class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                            placeholder="**************">
                                    </div>
                                    ...
                                    <div class="mt-6 flex items-center justify-end gap-x-6">
                                        ...
                                        <button name="submit" type="submit"
                                            class="rounded-md bg-blue-500 mx-5 ml-6 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Submit</button>
                                    </div>
                                </form>
                            </div>
                        </div>
